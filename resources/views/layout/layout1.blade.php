...
<html>
	<head>
		...
		<link
			...
			sizes="180x180"
			href="admin/vendors/images/apple-touch-icon.png"
		/>
		<link
			rel="icon"
			type="image/png"
			sizes="32x32"
			href="admin/vendors/images/favicon-32x32.png"
		/>
		<link
			rel="icon"
			type="image/png"
			sizes="16x16"
			href="admin/vendors/images/favicon-16x16.png"
		/>
				...
				<div class="user-info-dropdown">
					<div class="dropdown">
						<a
							...
							data-toggle="dropdown"
						>
							<span class="user-icon" id="profilePicture">
								<img src="<?=Session::get('image')?>" id="propic" alt="" />
							</span>
							<div class="user-name" id="nameUser"><?=Session::get('name')?></div>
						</a>
						<div
		...
		<div class="left-side-bar">
			<div class="brand-logo">
				<a href="index.html">
					...
					<img
						src="admin/vendors/images/deskapp-logo-white.svg"
						alt=""
						class="light-logo"
					/>
				</a>
