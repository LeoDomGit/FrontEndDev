...
{{-- end Modal --}}
      ...
      <tr>
        ...
        <td><div class="mt-2">
          <button class="btn btn-warning editBtn" data-id="{{$item->idProd}}">Sửa</button> <button class="btn btn-danger">Xóa</button> <button class="btn btn-success proddetailbtn" data-id="{{$item->idProd}}" data-toggle="modal" data-target="#productDetail{{$item->idProd}}">Chi tiết</button> <button class="btn btn-warning btnAddImageProduct" data-toggle="modal" data-toggle="modal" data-target="#AddMoreImgModal">Thêm hình ảnh</button></div></td>
      </tr>
      @endforeach
